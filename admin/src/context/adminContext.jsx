...
const AdminContextProvider=(props)=>{
    ...
    //api to change availabilty of doctor
    ...
    const cancelAppointment=async(appointmentId)=>{
        try {
            ...
            if(data.success){
                toast.success(data.message)
                getAllAppointments() // after cancelling the appointment, we have to fetch latest appointments detail
            } else {
                toast.error(data.message)
            }
